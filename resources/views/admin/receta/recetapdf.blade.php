                ...
                <td style="width: 50%;">
                    ...
                    <table>
                        <thead>
                            ...
                            <td style="font-size: 20px; font-style: italic; font-weight: bold; border-color: white;">
                                INDICACIONES</td>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <br>
                                <br>
                                <p style="margin: 6; padding: 0; font-size: 9px; text-align: center;">
                    ...
                    <table>
                        ...
                        @if ($receta->sugerencia)
                            <div style="padding: 0; font-size: 9px; text-align: left;">
                                <p style="margin: 6; padding: 0; font-size: 13px;"><strong
                                        style="font-size: 13px;">Signos de Alarma: </strong>{{ $receta->signos }}</p>
                                <p style="margin: 6; padding: 0; font-size: 13px; line-height: 1;"><strong>Sugerencia No
                                        Farmacológica:</strong>
                                <ol
                                    style="margin: 5; padding: 3; font-size: 13px; list-style-type: none; columns: 2; line-height: 1;">
